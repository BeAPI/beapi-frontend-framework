...
?>
	...
	<div class="animations-example">
		...
		<div class="container">
			<h4 class="animation-0">
				<strong>Line by line animation</strong> - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut commodo consequat.
			</h4>
			<div class="animation-1">Opacity animation</div>
			<div class="animation-2">Fade up animation</div>
			<div class="animation-3">Fade up animation with delay</div>
			<div class="animation-4"><p>Custom animation</p></div>
		</div>
	</div>

	<div class="blocks-container" style="padding: 100px 0">
		...
		<div class="wp-block-media-text is-stacked-on-mobile">
			<figure class="wp-block-media-text__media"><img loading="lazy"
															src="https://picsum.photos/1600/800" alt=""
															class="wp-image-22 size-full"></figure>
