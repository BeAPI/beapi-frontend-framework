...
loadCSS("//fonts.googleapis.com/css?family=Roboto:400,500,700");var roboto400=new FontFaceObserver("Roboto",{weight:400}),roboto700=new FontFaceObserver("Roboto",{weight:700});Promise.all([roboto400.check(),roboto700.check()]).then(function(){document.documentElement.className+=" fonts-loaded"});
